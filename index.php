...
<?php  
        /*  There are the php code that make a logical commands to do a safe signup  */
    include '_include/code_system_signup.php';
?>

<?php
        /* There are the php code that make a logical commands to do a safe login */
    include '_include/code_system_login.php';
?>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <?php 
                        ...
                        if(isset($message_psw_not_confirmed)){
                            echo $message_psw_not_confirmed;
                        }   
                        if(isset($message_user_signup)){
                            echo $message_user_signup;
                        }
                        if(isset($message_psw_signup)){
                            echo $message_psw_signup;
                        }
