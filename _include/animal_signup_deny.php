       ...
       <script>
        ...
        <div class="container" style="position:absolute; width:94%; left:3%; right:3%; height: 10%; top:40%; bottom:40%;">
            <div class="alert alert-warning text-center" style="display:none">
                <strong>ERROR!</strong> Você tentou cadastrar um animal com um nome ou um código de um animal já existente no banco de dados.
            </div>
            
             <a href="../pesquisa/"><button style="width:100%;" type="button" class="btn btn-danger">VOLTAR</button></a>
